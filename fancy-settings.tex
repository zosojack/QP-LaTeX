...
\titleformat{\chapter}[display]
  ...
  {Chapter \thechapter} % "Capitolo #" allineato a sinistra
  {20pt} % Spaziatura tra "Capitolo #" e il titolo
  {\Huge} % Nessun comando aggiuntivo per il titolo

\titlespacing{\section}{0pt}{30pt}{10pt} % Aumento margine in alto per sezioni
...
% per numeri romani
\newcommand{\Rnum}[1]{\uppercase\expandafter{\romannumeral #1}} % Maiuscoli
\newcommand{\rnum}[1]{\romannumeral #1}                        % Minuscoli
...
\newcommand{\tran}{\textsc{\small{T}}}
\newcommand{\refl}{\textsc{\small{R}}}
...
\newcommand{\question}[2]{%
    \begin{tcolorbox}[breakable, colback=questioncolor!4!white, colframe=questioncolor!95!black, title={\calloutfont {\small{Question}.} #1}]
        #2
    \end{tcolorbox}
}
...
\newcommand{\callout}[2]{%
    \begin{tcolorbox}[breakable, colback=calloutcolor!4!white, colframe=calloutcolor!95!black, title={\calloutfont #1}]
        #2
    \end{tcolorbox}
}
...
\newcommand{\calloutwarn}[1]{%
    \begin{tcolorbox}[breakable, colback=calloutwarncolor!3!white, colframe=calloutwarncolor!99!black, title={\faExclamationTriangle}]
        #1
    \end{tcolorbox}
}
% Callout errore
...
\newcommand{\callouterror}[1]{%
    \begin{tcolorbox}[breakable, colback=callouterrorcolor!3!white, colframe=callouterrorcolor!99!black, title={\faTimesCircle}]
        #1
    \end{tcolorbox}
}
...
\newcommand{\calloutinfo}[1]{%
    \begin{tcolorbox}[breakable, colback=calloutinfocolor!3!white, colframe=calloutinfocolor!99!black, title={\faInfoCircle}]
        #1
    \end{tcolorbox}
}

% Evidenziare il testo con \hl{testo evidenziato}
\usepackage{soul}
