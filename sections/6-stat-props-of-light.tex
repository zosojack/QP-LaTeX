...
If we recall the Mach-Zehnder interferometer (Fig.~\ref{fig:1-mach-zehnder}), the interference fringes are determined by the phase difference between the beams propagating along the two optical paths. All the discussion made before assumes a stable source frequency.
...
\begin{equation}\label{eqn:6-chaotic-light-intensity}
    ...
    =\varepsilon_0 c\, \frac{1}{2}E_0^2 a^2(t)
\end{equation}
...
\[
g^{(1)}(\tau)=e^{-i\omega_0\tau}\, \langle e^{i[\phi(t+\tau)-\phi(t)]}\rangle.
\]
