...
2\, I(t_1)\, I(t_2) \leq I^2(t_1)+I^2(t_2)
\end{equation}
...
\[\braket{I(t) \, I(t+\tau)} \leq \braket{I(t)}^2\]

\[\implies g^{(2)}(\tau) = \frac{\braket{I(t)\, I(t+\tau)}}{\braket{I(t)}^2} \leq 1 \leq g^{(2)}(0) \]
...
\begin{enumerate}
    ...
    \end{cases}
    \quad \implies \quad g^{(2)}(0)>g^{(2)}(\infty).
    \]
