...
\begin{equation}
\begin{cases}
    E_x(z,t) = E_{0,x} \cos(kz - \omega t + \phi_1)\\[0.5ex]
...
\[
\vec{E}(z,t) = \Re \left\{ E_0 \, e^{\phi_1}\,  \left( \cos\theta\, \hat{x} + e^{i\Delta\phi}\sin\theta\, \hat{y} \right) e^{i(kz - \omega t)} \right\}
\]
