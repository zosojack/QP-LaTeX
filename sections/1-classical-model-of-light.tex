\chapter{Phenomena explained by the classical model of light}\label{chap:1-classical-model-of-light}
...
\begin{itemize}
     \item Path A
     \[S_1 \to S_2 \to S_4 \hspace{1.5cm}\frac{1}{2}\,  E_0 \, \cos(\omega t + \phi_1)\]
     \item Path B
     \[S_1 \to S_3 \to S_4 \hspace{1.5cm} \frac{1}{2} E_0 \, \cos(\omega t + \phi_2)\]
\end{itemize}
...
\[C \, E^2(x,t) \implies 
I = C \, E_0^2 \, \braket{\cos^2(\omega t)} \propto \frac{1}{2} E_0^2
\]

Where $C$ is a normalization constant.
\item Intensity incident on $D_1$:
\[I_{D_1} = C \, E_0^2 \, \braket{[\cos(\omega t + \phi_1)+\cos(\omega t + \phi_2)]^2}
= \frac{1}{2} I_0 \, 
...
\begin{equation}
\begin{cases}
    I_{D_1} = \frac{I_0}{2}\bigl(1+\cos\Delta\phi\bigr)\\[0.5ex]
...
\begin{equation}
\begin{cases}
I_{D_1}=I_0\cos^2\!\left(\frac{\Delta\phi}{2}\right)\\[0.5ex]
